    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires', models.DateTimeField(default=datetime.datetime(2019, 12, 25, 20, 20, 40, 217305, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key1', models.TextField(max_length=64)),
                ('key2', models.TextField(max_length=64)),
                ('expires', models.DateTimeField(default=datetime.datetime(2019, 12, 25, 20, 20, 40, 254296, tzinfo=utc))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
